...
const Cleanliness = () => {
  ...
  useEffect(() => {
    ...
    if (storedComplaints) {
      ...
      // Filter only cleanliness complaints and sort by likes
      const cleanlinessComplaints = allComplaints
        .filter((complaint: Complaint) => complaint.category === 'cleanliness')
        .sort((a: Complaint, b: Complaint) => b.likes - a.likes);
      setComplaints(cleanlinessComplaints);
    }
  }, []);
      ...
      <main className="flex-grow px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold">Cleanliness Issues</h1>
            <Link to="/complaint">
          ...
          {complaints.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">No cleanliness issues reported yet.</p>
            </div>
          )}
        </div>
      </main>
