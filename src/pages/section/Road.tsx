...
const Road = () => {
  ...
  useEffect(() => {
    ...
    if (storedComplaints) {
      ...
      // Filter only road complaints and sort by likes
      const roadComplaints = allComplaints
        .filter((complaint: Complaint) => complaint.category === 'road')
      ...
      <main className="flex-grow px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold">Road Issues</h1>
            <Link to="/complaint">
          ...
          {complaints.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">No road issues reported yet.</p>
            </div>
          )}
        </div>
      </main>
